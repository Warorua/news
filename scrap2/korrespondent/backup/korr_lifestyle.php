...
////////////////////////////////////////////////////////////////////////////////////////
///////////////         HOME PAGE TRENDING            ///////////////////////////////
$link = 'https://ua.korrespondent.net/all/lifestyle/';
$output = '';
//Title
...
//Image
//$img = $response->find('div.layout-content div.cols div.col__big div.article div.article__title ');
$pic_1 = "[NO PREVIEW IMAGE FOR THIS CAT]";
$output .= $pic_1.'<br/>';
//$output .= sizeof($img).' - size of image array <br/>';

//Link HREF
$href =  $response->find('div.layout-content div.cols div.col__big div.article div.article__title h2 a');
$f_href = $href[0]->href;
$output .= $f_href.'<br/>';

//Date
$date =  $response->find('div.layout-content div.cols div.col__big div.article div.article__date a');
...
if($s_article_p > $s_article_div){
    $article = $content->find('.col__big div.post-item div.post-item__text p'); 
}
elseif($s_article_div > $s_article_p){
    $article = $content->find('.col__big div.post-item div.post-item__text div');
}

$ar_0 = '';
foreach($article as $ar){
    //$output .= $ar->plaintext."<br/>";
    $ar_0 .= $ar->plaintext."<br/>";
    
}

$ar_00 =  str_replace("Корреспондент.net", "ukrzmi.com", $ar_0)."<br/>";
$ar_1 = str_replace("https://t.me/korrespondentnet", " ", $ar_00)."<br/>";
$output .= $ar_1."<br/>";
$output .= "Новини від Корреспондент.net в Telegram. Підписуйтесь на наш канал https://t.me/korrespondentnet<br/>";
...
//insert into database
  ...
  $stmt->execute(['parent'=>$parent, 'source'=>"ua.korrespondent.net/all/lifestyle/", 'deep_link'=>$f_href, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>"Lifestyle", 'time'=>$time, 'code'=>$code]);
