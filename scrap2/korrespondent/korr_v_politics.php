...
////////////////////////////////////////////////////////////////////////////////////////
///////////////         HOME PAGE TRENDING            ///////////////////////////////
$link = 'https://ua.korrespondent.net/video/politics/';
$output = '';
//Title
...
//Image
$img = $response->find('.articles-grid div.articles-grid_block div.unit-rubric div.article a.article__img-link noscript img');
$pic_1 = $img[0]->src;
$output .= $pic_1.'<br/>';
//$output .= sizeof($img).' - size of image array <br/>';

//Link HREF
$href =  $response->find('.articles-grid div.articles-grid_block div.unit-rubric div.article a.article__img-link');
$f_href = $href[0]->href;
$output .= $f_href.'<br/>';

//Date
$date =  $response->find('.articles-grid div.articles-grid_block div.unit-rubric div.article div.article__title div.article__time');
...
//Video Fetch
$output .= '<h3>Video</h3>';
$video_2 =  $content->find('.col__big div.post-item div.post-item__text iframe');
...
//insert into database
  ...
  $stmt->execute(['video_url'=>$video_f, 'type'=>$news_type, 'parent'=>$parent, 'source'=>"ua.korrespondent.net/video/politics/", 'deep_link'=>$f_href, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>"Політика", 'time'=>$time, 'code'=>$code]);
