...
////////////////////////////////////////////////////////////////////////////////////////
///////////////         HOME PAGE TRENDING            ///////////////////////////////
$link = 'https://ua.korrespondent.net/business/financial/';
$output = '';
//Title
...
//insert into database
  ...
  $stmt->execute(['parent'=>$parent, 'source'=>"ua.korrespondent.net/business/economics/", 'deep_link'=>$f_href, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>"Економіка", 'time'=>$time, 'code'=>$code]);
