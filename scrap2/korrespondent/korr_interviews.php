...
////////////////////////////////////////////////////////////////////////////////////////
///////////////         HOME PAGE TRENDING            ///////////////////////////////
$link = 'https://ua.korrespondent.net/interview/';
$output = '';
//Title
...
//Image
$img = $response->find('div.layout-content div.cols div.col__main div.article_top a.article__img-link img');
$pic_1 = $img[0]->src;
$output .= $pic_1.'<br/>';
//$output .= sizeof($img).' - size of image array <br/>';

//Link HREF
$href =  $response->find('div.layout-content div.cols div.col__main div.article_top a.article__img-link');
$f_href = $href[0]->href;
$output .= $f_href.'<br/>';

//Date
$date =  $response->find('div.layout-content div.cols div.col__main div.article_top div.article__date');
...
//insert into database
  $stmt = $conn->prepare("INSERT INTO news (type, parent, source, deep_link, title, published, author, article, tag_1, tag_2, tag_3, photo, photo_url, p_grapher, category, time, code) VALUES (:type, :parent, :source, :deep_link, :title, :published, :author, :article, :tag_1, :tag_2, :tag_3, :photo, :photo_url, :p_grapher, :category, :time, :code)");
  $stmt->execute(['type'=>$news_type, 'parent'=>$parent, 'source'=>"ua.korrespondent.net/interview/", 'deep_link'=>$f_href, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>"Інтерв'ю", 'time'=>$time, 'code'=>$code]);
