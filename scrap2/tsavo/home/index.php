...
<!-- Main content -->
			...
			<div id="justSold" style="width:100%;" class='wrap-products style-nav-4 '>
...
<!--------=======================start up tickets selling======================================--------->
		...
		<div class="">
			...
			<div id="sponsored" style="width:100%;" class='wrap-products style-nav-4 '>
	               	</div></div></div></div>
<!---------==================product on sale=======================================================------>
				...
				<div class="wrap-countdown mercado-countdown" data-expire="2021/05/12 12:34:56"></div>
			<div id="Supermarket" style="width:100%;" class='wrap-products style-nav-4 '>
...
<!----======================================part 2================================================================----->
			...
			<div id="liquor" style="width:100%;" class='wrap-products style-nav-4 '>
...
<!---------===============================================men Wear==============================================================------------------>
<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box graa">Televisions <i class="flaticon-fire" style="color:orange" aria-hidden="true"></i></h3>
				<div class="wrap-countdown mercado-countdown" data-expire="2021/12/12 12:34:56"></div>
			<div id="Televisions" style="width:100%;" class='wrap-products style-nav-4 '>
	         </div>        
<!----=====end=====----->
<!---------===============================================men Wear==============================================================------------------>
<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box graa">Hot Ladies Wear <i class="flaticon-fire" style="color:orange" aria-hidden="true"></i></h3>
				<div class="wrap-countdown mercado-countdown" data-expire="2021/12/12 12:34:56"></div>
			<div id="ladiesW" style="width:100%;" class='wrap-products style-nav-4 '>
	         </div>        
<!----=====end=====----->
<!---------===============================================men Wear==============================================================------------------>
<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box graa">Hot Men Wear <i class="flaticon-fire" style="color:orange" aria-hidden="true"></i></h3>
				<div class="wrap-countdown mercado-countdown" data-expire="2021/12/12 12:34:56"></div>
			<div id="menW" style="width:100%;" class='wrap-products style-nav-4 '>
	         </div>        
<!----=====end=====----->
					<?php
