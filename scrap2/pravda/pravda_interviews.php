...
//header("Content-Type: text/html; charset=utf-8");
$url="https://www.epravda.com.ua/interview/";
...
//insert into database
  ...
  $stmt->execute(['video_url'=>$video_f, 'type'=>$news_type, 'parent'=>$parent, 'source'=>"epravda.com.ua/interview/", 'deep_link'=>$h_link, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>"Інтерв'ю", 'time'=>$time, 'code'=>$code]);
