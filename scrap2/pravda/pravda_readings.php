...
//header("Content-Type: text/html; charset=utf-8");
$url="https://www.epravda.com.ua/publications/";
...
$output = '';
//Title
$title = $response->find('div.layout div.section_content div.content_column div.article_main div.article__content h3.article__title a', 0)->plaintext . PHP_EOL . PHP_EOL;
$output .= $title."<br/>";
//Image
...
//Link HREF
$href =  $response->find('div.layout div.section_content div.content_column div.article_main div.article__content h3.article__title a');
$f_href = $href[0]->href;
$output .= $f_href.'<br/>';
...
//Image Fetch
$output .= '<h3>Image</h3>';
$img_2 =  $content->find('meta[property=og:image]');
...
//insert into database
  ...
  $stmt->execute(['video_url'=>$video_f, 'type'=>$news_type, 'parent'=>$parent, 'source'=>"epravda.com.ua/publications/", 'deep_link'=>$h_link, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>"читання", 'time'=>$time, 'code'=>$code]);
