...
$output = '';
//Title
$title = $response->find('.article div.article_body div.article_content_wrapper div.article_content div.article_footer div.article_footer_header a', 1)->plaintext . PHP_EOL . PHP_EOL;
$output .= $title."<br/>";
//Image
//$img = $response->find('.article div.article_body div.article_content_wrapper div.article_content div.article_footer div.article_footer_header a');
//$pic_1 = $img[0]->src;
//$output .= $pic_1.'<br/>';
//$output .= sizeof($img).' - size of image array <br/>';
//Link HREF
$href =  $response->find('.article div.article_body div.article_content_wrapper div.article_content div.article_footer div.article_footer_header a');
$f_href = $href[1]->href;
$output .= $f_href.'<br/>';
...
//$photographer = ltrim($f_graph, $trm);  
}
else{
    $photographer = "None"; 
}
