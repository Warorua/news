...
$output = '';
//Title
$title = $response->find('div.section_header div.layout_main div.container_top_articles_list_wrapper div.article div.article_body div.article_content div.article_header h3 a', 0)->plaintext . PHP_EOL . PHP_EOL;
$output .= $title."<br/>";
//Image
