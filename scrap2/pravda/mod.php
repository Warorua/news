...
$output = '';
//Title
$title = $response->find('div.center_column div.block_top div.main_news div.block div.article div.article__content h3 a', 0)->plaintext . PHP_EOL . PHP_EOL;
$output .= $title."<br/>";
//Image
...
//Link HREF
$href =  $response->find('div.center_column div.block_top div.main_news div.block div.article div.article__content h3 a');
$f_href = $href[0]->href;
$output .= $f_href.'<br/>';
