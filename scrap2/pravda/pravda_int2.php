...
$output = '';
//Title
$title = $response->find('div.section_header div.layout_main div.container_top_articles_list_wrapper div.article div.article_body div.article_content div.article_header h3 a', 1)->plaintext . PHP_EOL . PHP_EOL;
$output .= $title."<br/>";
//Image
...
$article =  $content->find('div.block_post div.post_content div.post_content_wrapper div.post_text p');
$ar_1 = '';
...
//insert into database
  ...
  $stmt->execute(['video_url'=>$video_f, 'type'=>$news_type, 'parent'=>$parent, 'source'=>"pravda.com.ua/interview/", 'deep_link'=>$h_link, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>$photographer, 'category'=>mb_convert_encoding("Інтерв'ю", "cp1251"), 'time'=>$time, 'code'=>$code]);
