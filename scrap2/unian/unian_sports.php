...
//insert into database
  ...
  $stmt->execute(['parent'=>"unian.ua", 'source'=>"Unian.ua/sports", 'deep_link'=>$f_href, 'title'=>$title, 'published'=>$published, 'author'=>$p_author, 'article'=>$ar_full, 'tag_1'=>$tag1, 'tag_2'=>$tag2, 'tag_3'=>$tag3, 'photo'=>$filename, 'photo_url'=>$image, 'p_grapher'=>"None", 'category'=>"Спорт", 'time'=>$time, 'code'=>$code]);
